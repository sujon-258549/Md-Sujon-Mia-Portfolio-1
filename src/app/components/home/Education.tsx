  ...
  const educationData = [
    {
      ...
      description:
        "4-year technical diploma with a focus on programming, networking, and hardware fundamentals.",
    ...
    <section id="education" className="py-16 text-white transition-all">
      <div className="">
        ...
        <div className="grid grid-cols-1 pt-5 md:pt-3 lg:pt-8 md:grid-cols-2 gap-10 items-center">
          {/* Illustration */}
          <div className="flex md:justify-start justify-center relative group">
